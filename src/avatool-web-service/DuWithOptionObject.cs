...
// DuWithOptionObject.cs (b200630.1232): OptionObject logic.
// Authors:
 ...
 *
 * Once it has been determined that the code functions as expected, it should be copied to "DuWithOptionOjectTesting.asmx.cs"
 */
